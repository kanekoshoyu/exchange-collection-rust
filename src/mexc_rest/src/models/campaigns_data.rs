...
pub struct CampaignsData {
    ...
    /// Total number of campaign records available.
    ...
    /// List of campaign data for the affiliate.
    #[serde(rename = "resultList", skip_serializing_if = "Option::is_none")]
    pub result_list: Option<Vec<models::CampaignsDataResultListInner>>,
}

impl CampaignsData {
    pub fn new() -> CampaignsData {
        CampaignsData {
            page_size: None,
            total_count: None,
            total_page: None,
