...
/// MarginAccountMarginRequirements : A structure containing the account's margin requirements.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct MarginAccountMarginRequirements {
...
impl MarginAccountMarginRequirements {
    /// A structure containing the account's margin requirements.
    pub fn new() -> MarginAccountMarginRequirements {
        MarginAccountMarginRequirements {
            im: None,
            mm: None,
            lt: None,
            tt: None,
