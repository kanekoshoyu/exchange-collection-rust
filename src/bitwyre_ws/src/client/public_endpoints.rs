...
#[derive(Debug)]
pub struct BitwyrePublicEndpointsClient {
	base_url: String,
}

impl BitwyrePublicEndpointsClient {
	/// connect to the bitwyre websocket server
	pub async fn new() -> Self {
		Self {
			base_url: "wss://api.bitwyre.com/ws/public".to_string(),
 		}
	}
...
/// #[tokio::main]
/// async fn main() {
///     use exchange_collection_ws_bitwyre:: client::public_endpoints::BitwyrePublicEndpoints Client;
///     let mut client = BitwyrePublicEndpoints Client::new ().await;
