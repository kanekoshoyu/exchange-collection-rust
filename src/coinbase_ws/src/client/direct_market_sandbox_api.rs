...
#[derive(Debug)]
pub struct CoinbaseDirectMarketSandboxApiClient {
	base_url: String,
}

impl CoinbaseDirectMarketSandboxApiClient {
	/// connect to the coinbase websocket server
	pub async fn new() -> Self {
		Self {
			base_url: "wss://ws-direct.sandbox.exchange.coinbase.com/".to_string(),
 		}
	}
