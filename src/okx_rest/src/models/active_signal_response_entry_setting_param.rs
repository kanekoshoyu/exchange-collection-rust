...
pub struct ActiveSignalResponseEntrySettingParam {
    ...
    /// Amount per order (only applicable to entry types 2 and 3).
    #[serde(rename = "amt", skip_serializing_if = "Option::is_none")]
    pub amt: Option<String>,
    /// Amount ratio per order (only applicable to entry types 4 and 5).
    #[serde(rename = "ratio", skip_serializing_if = "Option::is_none")]
    pub ratio: Option<String>,
}

impl ActiveSignalResponseEntrySettingParam {
    pub fn new() -> ActiveSignalResponseEntrySettingParam {
        ActiveSignalResponseEntrySettingParam {
