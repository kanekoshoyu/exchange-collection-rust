...
pub struct WithdrawalPaymentMethodsResponseAccountsInner {
    ...
    /// The fee rate for each deposit, expressed as a percentage (e.g., 0.02 for 2 percent fee for each transaction).
    #[serde(rename = "feeRate", skip_serializing_if = "Option::is_none")]
    pub fee_rate: Option<String>,
    /// The lifetime transaction limit. Returns an empty string if not configured.
    #[serde(rename = "lifetimeLimit", skip_serializing_if = "Option::is_none")]
    pub lifetime_limit: Option<String>,
    #[serde(rename = "limits", skip_serializing_if = "Option::is_none")]
    pub limits: Option<Box<models::WithdrawalPaymentMethodsResponseAccountsInnerLimits>>,
    ...
    /// The payment method associated with the currency (e.g., SEPA, TR_BANKS, PIX).
...
impl WithdrawalPaymentMethodsResponseAccountsInner {
    pub fn new() -> WithdrawalPaymentMethodsResponseAccountsInner {
        WithdrawalPaymentMethodsResponseAccountsInner {
            acct_num: None,
            bank_code: None,
            bank_name: None,
            ccy: None,
