...
pub struct ActiveSignalResponse {
    ...
    /// Investment amount for the algorithm.
    ...
    /// Price offset ratio, applied to limit orders.
    #[serde(rename = "ratio", skip_serializing_if = "Option::is_none")]
    pub ratio: Option<String>,
    #[serde(rename = "entrySettingParam")]
    pub entry_setting_param: Box<models::ActiveSignalResponseEntrySettingParam>,
    #[serde(rename = "exitSettingParam")]
    pub exit_setting_param: Box<models::ActiveSignalResponseExitSettingParam>,
    /// Signal channel ID.
...
impl ActiveSignalResponse {
    pub fn new(algo_id: String, inst_type: String, inst_ids: Vec<String>, algo_ord_type: String, state: State, total_pnl: String, total_eq: String, float_pnl: String, realized_pnl: String, frozen_bal: String, avail_bal: String, invest_amt: String, sub_ord_type: SubOrdType, entry_setting_param: models::ActiveSignalResponseEntrySettingParam, exit_setting_param: models::ActiveSignalResponseExitSettingParam, signal_chan_id: String, signal_chan_name: String, signal_source_type: SignalSourceType) -> ActiveSignalResponse {
