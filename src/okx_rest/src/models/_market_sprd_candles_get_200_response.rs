...
pub struct MarketSprdCandlesGet200Response {
    /// Response code
...
impl MarketSprdCandlesGet200Response {
    pub fn new() -> MarketSprdCandlesGet200Response {
        MarketSprdCandlesGet200Response {
            code: None,
            msg: None,
            in_time: None,
            out_time: None,
